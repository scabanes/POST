...
! ----------- Saturne:
!ptimestep=4756.50
!real*8 :: Amp = 0.22,kf=56.,ptimestep= 3805.2,radius = 58232000, omega = 0.000165121, H = 59000 ![radius] = m, depth: [H] = m, omega sat:0.000165121  ! [omega]= s-1 ! ptimestep = 1189.125 ; 3805.2 (itau_physics=10 ; 32) ;
! ----------- Jupiter:
